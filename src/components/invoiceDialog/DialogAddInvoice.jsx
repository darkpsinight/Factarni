...
import { addInvoice } from 'src/Service/apiInvoice'
...
const DialogAddInvoice = () => {
  const [date, setDate] = useState(dayjs(Date())) //                           date state
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <TextField
                      ...
                      value={discountOnTotal.toFixed(3)}
...
export default DialogAddInvoice

DialogAddInvoice.propTypes = {
